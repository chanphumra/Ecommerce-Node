...
import NewArrivalsIcon from '../assets/icons/newarrivals.png'
...
const NewArrivals = (props) => {
    ...
    const getProducts = async () => {
        await axios.get(
            'http://localhost:8000/api/product/details/get/all/new'
        ).then(res => {
        ...
        <div className="mt-10">
            <div className="flex justify-between items-end">
                <div className="flex items-center">
                    <img src={NewArrivalsIcon} alt="" className='w-8 h-8 mr-1' />
                    <span className='text-2xl font-[700] text-gray-800 capitalize'>New Arrivals</span>
                </div>
